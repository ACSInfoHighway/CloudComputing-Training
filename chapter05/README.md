...
> 注1：进入这一章后会用到各种语言的工具，比如Java, Python, Go，此时版本的管理尤为重要。Java方面，JDK和JRE的版本请查阅资料利用环境变量. Maven, Gradle等工具进行“优雅地”多版本管理；Python方面，建议利用anaconda进行环境(env)管理，为每个任务建立隔离的环境，可以自行查阅相关使用文档；Go版本可以使用gvm管理，包版本之间的依赖使用go modules进行管理，配合JetBrains GoLand IDE进行使用；
> 
